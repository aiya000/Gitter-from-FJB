...
function load(){
	...
	xmlhttp.onreadystatechange = function(){
		if(xmlhttp.readyState==4 && xmlhttp.status==200){
			...
			document.getElementById("tweetArea").innerHTML = textToFormat(tweetList);
		}
	}

	//PHPと連携
	xmlhttp.open("GET", "fetchTweet.php", true);
	xmlhttp.send();
}
...
/* ツイートリストから最終出力フォーマットに変換 */
function textToFormat(tweetList){
	var list = "";
